...
class Config:
    ...
    DEFAULT_CONFIGS = {
        PROVIDER_GEMINI: LLMConfig(
            ...
            model="gemini-3.5-flash",  # Fast Gemini model
            temperature=0.7,
            max_tokens=2048,
    ...
    PREMIUM_CONFIGS = {
        PROVIDER_GEMINI: LLMConfig(
            provider=PROVIDER_GEMINI,
            model="gemini-3.5-flash",  # More capable Gemini model
            temperature=0.7,
            max_tokens=4096,
            api_key=os.getenv("GEMINI_API_KEY"),
            base_url="https://generativelanguage.googleapis.com/v1beta"
        ...
        PROVIDER_GROQ: LLMConfig(
            provider=PROVIDER_GROQ,
            model="meta-llama/llama-4-scout-17b-16e-instruct",  # More capable model
            temperature=0.7,
            max_tokens=4096,
            api_key=os.getenv("GROQ_API_KEY"),
            base_url="https://api.groq.com/openai/v1"
